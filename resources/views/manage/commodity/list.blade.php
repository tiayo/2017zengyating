...
@section('breadcrumb')
    ...
    <li navValue="nav_0_3"><a href="#">商品管理</a></li>
@endsection
		...
		<section class="panel">
            <div class="panel-body">
                <form class="form-inline" id="search_form">
                    <button type="button" class="btn btn-success" onclick="location='{{ route('commodity_add') }}'">添加商品</button>
                    <div class="form-group">
                        <label class="sr-only" for="search"></label>
                        <input type="text" class="form-control" id="search" name="keyword"
                               value="{{ Request::get('keyword') }}" placeholder="输入商品" required>
                    </div>
